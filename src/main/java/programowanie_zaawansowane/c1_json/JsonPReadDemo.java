...
public class JsonPReadDemo {
  public static void main(String[] args) {
    try{
      ...
      //uzyskujemy readera odczytującego ze strumienia url-a
        ...
        {                                                             obiekt
          ...
          [                                                           tablica
            {                                                         obiekt bez nazwy, numer 0
              "id": "1767324",                                        klucz: wartość typu String
      ...
      jsonObj
        .getJsonArray("Dataobject")                 //pobranie tabicy Dataobject
        .get(0).asJsonObject()                          //pobranie elementu o indeksie 0 z tablicy i konwersja do obiektu
        .forEach((key, val)-> {                         //dla każdego klucza key o wartości val
        if (key.equals("data")) {                       //jeśli to pole o kluczu "data"
